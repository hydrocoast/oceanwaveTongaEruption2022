...
#------------------------------
    ...
    #regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 124.0, 148.0, 15.0, 45.0]) # around Japan
    regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 124.0, 140.0, 15.0, 35.5]) # West Japan
    regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 138.0, 145.0, 22.0, 45.0]) # East Japan
...
#-------------------
    ...
    data.storm_file = os.path.join(os.getcwd(),'../forcing/lamb_nwp/')
