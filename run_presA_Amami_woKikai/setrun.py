...
topoflist = {
             ...
             "Amami_noKikai"  :"zone01_depth_0090_blend34_manipulated.asc",
...
#------------------------------
    ...
    ## Level 5
    topo_file = topotools.Topography(os.path.join(topodir, topoflist['Amami_noKikai']), topo_type=3)
...
#-------------------
    ...
    if int(clawpack.__version__.split('.')[1]) > 7: # v5.8.0 or later
        ...
        topo_data.topofiles.append( [3, os.path.join(topodir, topoflist['Amami_noKikai'])] )
    else: # v5.7.1
        ...
        topo_data.topofiles.append( [3, 1, 5, 0.0, 1.0e10, os.path.join(topodir, topoflist['Amami_noKikai'])] )
