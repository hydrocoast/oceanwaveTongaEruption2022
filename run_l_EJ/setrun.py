...
#------------------------------
    ...
    regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 138.0, 148.0, 20.0, 40.0]) # Chichijima, Chiba-Tohoku
    #regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 138.0, 150.0, 30.0, 45.0]) # Iwate - Hokkaido
    ...
    i#gauges.append([52404, 132.139, 20.629, 0., 1.e10]) #
...
#-------------------
    ...
    data.storm_file = os.path.join(os.getcwd(),'../forcing/lamb_wp/')
