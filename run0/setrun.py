...
#------------------------------
    ...
    regions.append([1, 4, clawdata.t0, clawdata.tfinal, 175.0, 195.0, -30.0, -10.0])
...
#-------------------
    ...
    if int(clawpack.__version__.split('.')[1]) > 7: # v5.8.0 or later
        ...
        topo_data.topofiles.append([4, 1, 4, 0.0e0, 1.0e10, os.path.join(topodir, 'gebco_2021_n60.0_s-60.0_w120.0_e300.0.nc')])
